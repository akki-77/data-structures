...
public class Fibonacci {
    ...
    public int findFib(int n) {
        ...
        /*
         * In case of multiple recursion call 2nd recursion call will start only when
         * 1st one is completed. i.e. Synchronously.
         * So first complete recursion tree for findFib(n-1) will be completed then only
         * findFib(n-2) will start getting executed.
         */
